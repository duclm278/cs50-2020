...
void lock_pairs(void)
{
    ...
    */
    ...
    for (int i = 0; i < pair_count; i++)
    {
        ...
        {
            if (pairs[previous].loser == pairs[j].winner)
            {
                if (locked[pairs[j].winner][pairs[j].loser] == true)
                {
                    if (pairs[j].loser == pairs[original].winner)
                    {
                        cycles++;
                        break;
                    }
        ...
        for (int j = 0; j < pair_count; j++)
        {
            if (pairs[previous].winner == pairs[j].loser)
            {
                if (locked[pairs[j].winner][pairs[j].loser] == true)
                {
                    if (pairs[j].winner == pairs[original].loser)
                    {
                        cycles++;
                        break;
                    }
